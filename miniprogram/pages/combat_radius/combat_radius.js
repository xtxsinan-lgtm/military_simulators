...
const EMPTY_AC = {
  ...
  fuse_height_m: '',
  nose_cone_length_m: '',
  nose_cone_diameter_m: '',
  nose_length_m: '',
  nose_root_diameter_m: '',
  fuse_body_length_m: '',
  main_wing_area_m2: '',
  canard_htail_area_m2: '',
  ventral_fin_area_m2: '',
  vtail_area_m2: '',
  mach_angle_deg: '',
  wing_area_m2: '',
...
Page({
  ...
  toAircraft() {
    ...
    return {
      ...
      fuse_width_m: num(ac.fuse_width_m, 0),
      fuse_height_m: num(ac.fuse_height_m, 0),
      nose_cone_length_m: num(ac.nose_cone_length_m, 0),
      nose_cone_diameter_m: num(ac.nose_cone_diameter_m, 0),
      nose_length_m: num(ac.nose_length_m, 0),
      nose_root_diameter_m: num(ac.nose_root_diameter_m, 0),
      fuse_body_length_m: num(ac.fuse_body_length_m, 0),
      main_wing_area_m2: num(ac.main_wing_area_m2, 0),
      canard_htail_area_m2: num(ac.canard_htail_area_m2, 0),
      ventral_fin_area_m2: num(ac.ventral_fin_area_m2, 0),
      vtail_area_m2: num(ac.vtail_area_m2, 0),
