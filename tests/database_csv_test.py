...
def test_load_combat_radius_aircraft_csv():
    ...
    assert j20['ld_known'] == pytest.approx(11.51)
...
def test_load_combat_radius_engine_csv():
    ...
    assert by_id['ws15']['tsl_kN'] == 112.0
    ...
    assert by_id['ws19']['tsl_kN'] == pytest.approx(68.0)
    assert by_id['ws21']['max_tsl_kN'] == 95.0
    assert by_id['ws21']['tsl_kN'] == pytest.approx(69.5)
